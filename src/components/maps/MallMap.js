...
const MallMap = () => {
    ...
    const markersRef = useRef(null); // Manage clusters dynamically
    const mallListContainerRef = useRef(null);
    ...
    const filteredMalls = malls.filter((mall) => {
        if (filter === "all")
            return true;
        if (filter === "Metro Manila")
            return mall.address.includes("Metro Manila");
        if (filter === "Cebu")
            return mall.address.includes("Cebu");
        if (filter === "Davao")
            return mall.address.includes("Davao");
        if (filter === "Pampanga")
            return mall.address.includes("Pampanga");
        if (filter === "rating:5")
            return mall.reviews[0]?.rating === 5;
        if (filter === "rating:4+")
            return mall.reviews[0]?.rating >= 4;
        if (filter === "rating:3+")
            return mall.reviews[0]?.rating >= 3;
        return false;
    });
    ...
    const paginatedMalls = filteredMalls.slice((currentPage - 1) * mallsPerPage, currentPage * mallsPerPage);
    useEffect(() => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { marginBottom: "10px" }, children: [_jsx("label", { htmlFor: "filter", children: "Filter by:" }), _jsxs("select", { id: "filter", onChange: (e) => setFilter(e.target.value), style: { marginLeft: "10px", padding: "5px" }, children: [_jsx("option", { value: "all", children: "All Locations" }), _jsx("option", { value: "Metro Manila", children: "Metro Manila" }), _jsx("option", { value: "Cebu", children: "Cebu" }), _jsx("option", { value: "Davao", children: "Davao" }), _jsx("option", { value: "Pampanga", children: "Pampanga" }), _jsx("option", { value: "rating:5", children: "Rating: 5 only" }), _jsx("option", { value: "rating:4+", children: "Rating: 4+" }), _jsx("option", { value: "rating:3+", children: "Rating: 3+" })] })] }), _jsxs("div", { style: {
                    display: "flex",
                    ...
                    overflowX: "hidden", // ✅ Prevent horizontal scroll
                }, children: [_jsx("div", { id: "map", ref: mapRef, style: {
                        ...
                        } }), _jsxs("div", { ref: mallListContainerRef, style: {
                            marginTop: "10px",
                            marginBottom: "60px",
                            padding: "10px",
                            width: "90vw",
                            ...
                            textAlign: "center"
                                ...
                                }, children: "List of Malls" }), _jsx("ul", { style: { listStyle: "none", padding: "0" }, children: paginatedMalls.map((mall) => (_jsxs("li", { style: {
                                        display: "flex",
                                    ...
                                    }, onDoubleClick: () => navigate(`/mall/${mall._id}`), children: [_jsx("span", { children: mall.name }), _jsx("span", { style: { cursor: "pointer", fontSize: "18px", color: "#007BFF" }, onClick: () => navigate(`/mall/${mall._id}`), children: "\u279C" })] }, mall._id))) }), _jsxs("div", { style: {
                                    marginTop: "10px",
                                    display: "flex",
                                    justifyContent: "center",
                                    gap: "10px"
                                }, children: [_jsx("button", { disabled: currentPage === 1, onClick: () => handlePageChange(currentPage - 1), style: { padding: "6px 12px", cursor: "pointer" }, children: "\u25C0 Prev" }), _jsxs("span", { children: ["Page ", currentPage, " of ", totalPages] }), _jsx("button", { disabled: currentPage === totalPages, onClick: () => handlePageChange(currentPage + 1), style: { padding: "6px 12px", cursor: "pointer" }, children: "Next \u25B6" })] })] })] })] }));
};
